...
class TestQuizCreation:
    ...
    def test_create_quiz_with_empty_students_list(self):
        response = self.client.post(
            "/quiz",
            json={
                "title": "Test Quiz",
    ...
    def test_create_classroom_with_duplicate_title(self):
        response = self.client.post(
            "/classroom",
            json={
                "title": "Math Class",
        ...
        assert response_duplicate.json()["message"] == "A classroom with the title 'Math Class' already exists. Consider using a different title."
    ...
    def test_create_quiz_assign_students(test_client):
        quiz_data = {
            "title": "Class Quiz",
